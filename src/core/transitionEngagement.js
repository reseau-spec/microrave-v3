...
async function transitionEngagement({
  ...
  // Transmettre le contractSnapshot si MCG l'a produit
...
async function runSpecificGuard({
  ...
  switch (guardName) {
    ...
    case 'SealingGuard':
      // balance_pending → event_sealed — WORM W2 — ContractSnapshot phase 2
      // Conditions : balance reçue + LOI LINEUP-01/02 + LOI LEDGER-02
