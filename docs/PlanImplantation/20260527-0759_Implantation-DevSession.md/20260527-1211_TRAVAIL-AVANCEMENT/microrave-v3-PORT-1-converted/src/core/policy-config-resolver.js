...
import { PolicyConfigRepository } from '../repositories/PolicyConfigRepository.js';
...
import { CRITICAL_CONFIG_KEYS } from '../../config/policy-config-schema.js';
...
export default {
getConfig, getConfigs, clearCache, validateCriticalConfigs 
};
export { getConfig, getConfigs, clearCache, validateCriticalConfigs };