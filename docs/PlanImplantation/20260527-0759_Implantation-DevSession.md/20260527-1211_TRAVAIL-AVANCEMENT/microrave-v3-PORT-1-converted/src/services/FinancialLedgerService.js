...
// DETTE-PORT-001 résolue : import { StripeReferenceGuard, Account6690DualApprovalGuard }
// supprimé. Ces noms n'existent pas comme exports nommés dans
// ../core/guards/StripeReferenceGuard.js (qui exporte des fonctions plates :
// validateStripeReference, verifyStripeTransferGroup, validateAccount6690DualApproval,
// etc.). Code mort dormant en CJS — fail-loud en ESM strict. Aucune utilisation
// du symbole dans ce fichier (vérifié par grep). Si l'intention était d'utiliser
// la fonction, ré-importer : import { validateStripeReference, validateAccount6690DualApproval }
